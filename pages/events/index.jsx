      ...
      <div className="mb-16">
        ...
        <div className="w-full bg-gray-100 md:px-10 md:p-8">
          <div className="container mx-auto">
            <div role="list" aria-label="Bitsa Events" className=" space-y-4">
                    ...
                    <div className="px-6 mt-10 flex flex-col">
                      ...
                      <div className="w-full  pt-5 pb-8 flex justify-center">
                        <Link
                          target={"_blank"}
                          href={
                            "https://huawei.com/en/seeds-for-the-future/competitions"
                          }
                          className="w-4/5 md:w-1/2 h-12 grid place-items-center bg-blue-500 rounded-full text-white font-semibold"
                        >
                          Register now
                        </Link>
                      </div>
